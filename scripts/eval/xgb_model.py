"""
xgb_model.py -- XGBoost classifier with Optuna HPO.
...
def tune_xgb(X_train, y_train,
             ...
             seed: int = SEED) -> dict:
    """
    Optuna HPO for XGBoost. Optimises PR-AUC via 3-fold CV.

    Returns
    -------
    best_params dict
    """
    logger.info(f"XGBoost HPO: {n_trials} trials")
    ...
    best.update({"eval_metric": "aucpr", "random_state": seed, "n_jobs": -1})
